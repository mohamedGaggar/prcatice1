...
<section style="width: 500px;margin-left:100px;margin-top: 200px;">
@if (Session::has('success'))
<p class="alert alert-success">{{Session::get('success')}}</p>
@else
<p class="alert alert-danger">the post could not be created</p>
@endif

<form action="{{route('admin.adminPage')}}" method="post" enctype="multipart/form-data">
    @csrf
  <div class="mb-3">
